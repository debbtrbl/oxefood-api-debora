...
public interface ProdutoRepository extends JpaRepository<Produto, Long> {
   ...
   @Query(value = "SELECT p FROM Produto p WHERE p.codigo = :codigo") // hql 
   List<Produto> consultarPorCodigo(String codigo);
   // ou List<Produto> findByCodigo(String codigo); 
   ...
   List<Produto> findByTituloContainingIgnoreCaseOrderByTituloAsc(String titulo); // ignora case e ordena ascendente
